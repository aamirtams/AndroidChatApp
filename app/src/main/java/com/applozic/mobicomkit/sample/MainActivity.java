...
import com.applozic.mobicomkit.uiwidgets.people.activity.ProfileActivity;
...
public class MainActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadDialog.setTitle(R.string.app_not_found);
        downloadDialog.setMessage(R.string.install_app);
...
//    }
    ...
    public void zamIconClick(View v){
   ...
   /* public void initiateChatClick(View v) {
    ...
    public void onLunchInstaApp(View v) {
    ...
    public void onLunchFacebookApp(View v) {
    ...
    public void onLunchTwitterApp(View v) {
    ...
    public void onLunchYouTubeApp(View v) {
    ...
    public void onLunchLinkedInApp(View v) {

        final String appPackageName = "com.linkedin.android";
    ...
    public void onLunchSnapChatApp(View v) {
