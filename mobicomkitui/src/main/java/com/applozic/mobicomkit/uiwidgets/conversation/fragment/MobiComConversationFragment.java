...
abstract public class MobiComConversationFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (emojiIconHandler == null && emoticonsBtn != null) {
            emoticonsBtn.setVisibility(View.VISIBLE);
        }
...
//        transaction.add(R.id.emojicons_frame_layout, emojiFragment).commit();
        ...
        final View rootView = list.findViewById(R.id.rootView);
        ...
        popup.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                changeEmojiKeyboardIcon(emoticonsBtn, R.drawable.smiley);
            }
        });
...
//    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        String contactNumber = contact != null ? contact.getUserId() : null;
           ...
           /* if (emoticonsFrameLayout.getVisibility() == View.VISIBLE) {
            ...
            if (!popup.isShowing()) {
                ...
                if (popup.isKeyBoardOpen()) {
                    popup.showAtBottom();
                    changeEmojiKeyboardIcon(emoticonsBtn, R.drawable.ic_action_keyboard);
                }
