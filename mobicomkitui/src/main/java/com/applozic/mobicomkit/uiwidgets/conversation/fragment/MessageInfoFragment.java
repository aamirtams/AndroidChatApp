...
public class MessageInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EmojiconTextView textView = (EmojiconTextView) view.findViewById(R.id.applozic_message_info_message_text);
    ...
    private void setupAttachmentView(Message message, RelativeLayout defaultRelativeLayout) {
        ...
        EmojiconTextView attachmentFilename = (EmojiconTextView) defaultRelativeLayout.findViewById(R.id.applozic_message_info_attachment_filename);
        EmojiconTextView messageText = (EmojiconTextView) defaultRelativeLayout.findViewById(R.id.messageText);
